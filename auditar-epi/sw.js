const CACHE='auditar-epi-v2-ai';
const ASSETS=['./','./index.html','./styles.css','./import-workers.css','./app.js','./import-workers.js','./ai-workers.js','./manifest.webmanifest','./icon.svg'];
