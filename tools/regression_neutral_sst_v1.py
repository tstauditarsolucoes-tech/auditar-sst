...
secure = (root / 'lib/services/auth_secure_store.dart').read_text(encoding='utf-8')
...
assert 'sst_gestao_offline_login_v1' in auth
...
print('NEUTRAL_REGRESSION_OK: SST Gestão sem identidade visual Auditar; banco/login/backups isolados; recursos principais preservados.')
